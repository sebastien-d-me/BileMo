...
/**
 * @extends ServiceEntityRepository<ApiAccount>
 *
 ...
 */
class ApiAccountRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(ApiAccount $entity, bool $flush = false): void
    {
    ...
    public function remove(ApiAccount $entity, bool $flush = false): void
    {
